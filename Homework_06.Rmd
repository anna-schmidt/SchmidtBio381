...
stat4 <- stat_function(aes(x = xval, y = ..y..), fun = dgamma, colour="brown", n = length(z$myVar), args = list(shape=shapeML, rate=rateML))
 p1 + stat + stat2 + stat3 + stat4 # maroon line is the gamma distribution
```
...
___
#### **Part 3**
**The best-fitting distribution for my zooplankton length data is the gamma distribution.**
